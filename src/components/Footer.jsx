...
const Footer = () => {
  return (
    <div className="bg-base border-t border-black">
      <footer className="footer xl:px-24 py-10 px-4 text-base-content border-black-600">
        <aside>
        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end ">
          ...
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current cursor-pointer text-red-500"
            >
          ...
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current cursor-pointer text-blue-600"
            >
          ...
          <a>
            <svg
              xmlns="https://www.linkedin.com/company/op-x/"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              className="fill-current cursor-pointer text-blue-600"
