...
const serviceLists = [
    ...
    {id:3, title: "Online Ordering", des: "Explore menu & order with  using our Online Ordering ", img: "/Images/home/services/icon3.png"},
    ...
    <div className="section-container my-16">
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2">
          <div className="text-left md:w-4/4">
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
                {
                    serviceLists.map((service) => (
                        <div key={service.id} className="shadow-md rounded-sm py-5 px-4 text-center rounded-xl space-y-2 text-green cursor-pointer hover:border hover:border-black  transition-all duration-200">
